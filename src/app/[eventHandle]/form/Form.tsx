...
export function Form({ event }) {
   ...
   return (
      <div className="lg:w-[400px] w-full px-5 lg:px-0 text-white text-sm ">
         ...
         <p>name</p>
         <div className="bg-neutral-700 border-2 p-2 border-purple-600 flex flex-row justify-between items-center">
            <input
               autoCapitalize="none"
               onChange={(e) => {
         ...
         >
            ...
            <div
               className="flex flex-row items-center cursor-pointer border border-white rounded-md px-3 py-2 "
               onClick={() => {
